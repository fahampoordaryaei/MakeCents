...
class GetUserPointsVariablesBuilder {
  ...
  Deserializer<GetUserPointsData> dataDeserializer = (dynamic json)  => GetUserPointsData.fromJson(jsonDecode(json));
  Serializer<GetUserPointsVariables> varsSerializer = (GetUserPointsVariables vars) => jsonEncode(vars.toJson());
  ...
  QueryRef<GetUserPointsData, GetUserPointsVariables> ref() {
    ...
    return _dataConnect.query("GetUserPoints", dataDeserializer, varsSerializer, vars);
  }
}
...
class GetUserPointsPointsBalances {
  ...
  bool operator ==(Object other) {
    ...
    final GetUserPointsPointsBalances otherTyped = other as GetUserPointsPointsBalances;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, totalPoints.hashCode, updatedAt.hashCode]);
