...
### GetContinentsForCountry
#### Required Arguments
```dart
int countryId = ...;
ExampleConnector.instance.getContinentsForCountry(
  countryId: countryId,
).execute();
```
...
#### Return Type
`execute()` returns a `QueryResult<GetContinentsForCountryData, GetContinentsForCountryVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.getContinentsForCountry(
  countryId: countryId,
);
GetContinentsForCountryData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.getContinentsForCountry(
  countryId: countryId,
).ref();
ref.execute();
...
int countryId = ...;
int continentId = ...;
ExampleConnector.instance.listScholarshipsForUser(
  countryId: countryId,
...
#### Return Type
`execute()` returns a `QueryResult<ListScholarshipsForUserData, ListScholarshipsForUserVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.listScholarshipsForUser(
  countryId: countryId,
  continentId: continentId,
);
ListScholarshipsForUserData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.listScholarshipsForUser(
  countryId: countryId,
  continentId: continentId,
).ref();
ref.execute();
...
### ListGlobalScholarships
#### Required Arguments
```dart
// No required arguments
ExampleConnector.instance.listGlobalScholarships().execute();
```



#### Return Type
`execute()` returns a `QueryResult<ListGlobalScholarshipsData, void>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.listGlobalScholarships();
ListGlobalScholarshipsData data = result.data;
final ref = result.ref;
```
...
An example of how to use the `Ref` object is shown below:
```dart
final ref = ExampleConnector.instance.listGlobalScholarships().ref();
ref.execute();
...
### ListUserScholarshipApplications
#### Required Arguments
```dart
String userId = ...;
ExampleConnector.instance.listUserScholarshipApplications(
  userId: userId,
).execute();
```
...
#### Return Type
`execute()` returns a `QueryResult<ListUserScholarshipApplicationsData, ListUserScholarshipApplicationsVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.listUserScholarshipApplications(
  userId: userId,
);
ListUserScholarshipApplicationsData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.listUserScholarshipApplications(
  userId: userId,
).ref();
ref.execute();
...
ExampleConnector.instance.scholarshipApplicationExists(
  userId: userId,
...
#### Return Type
`execute()` returns a `QueryResult<ScholarshipApplicationExistsData, ScholarshipApplicationExistsVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.scholarshipApplicationExists(
  userId: userId,
  scholarshipId: scholarshipId,
);
ScholarshipApplicationExistsData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.scholarshipApplicationExists(
  userId: userId,
  scholarshipId: scholarshipId,
).ref();
ref.execute();
...
### ListUserScholarshipAttachments
#### Required Arguments
```dart
String userId = ...;
ExampleConnector.instance.listUserScholarshipAttachments(
  userId: userId,
).execute();
```
...
#### Return Type
`execute()` returns a `QueryResult<ListUserScholarshipAttachmentsData, ListUserScholarshipAttachmentsVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.listUserScholarshipAttachments(
  userId: userId,
);
ListUserScholarshipAttachmentsData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.listUserScholarshipAttachments(
  userId: userId,
).ref();
ref.execute();
...
### UpdateUserAllowOverbudget
#### Required Arguments
```dart
String userId = ...;
bool allowOverbudget = ...;
ExampleConnector.instance.updateUserAllowOverbudget(
  userId: userId,
  allowOverbudget: allowOverbudget,
).execute();
```
...
#### Return Type
`execute()` returns a `OperationResult<UpdateUserAllowOverbudgetData, UpdateUserAllowOverbudgetVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.updateUserAllowOverbudget(
  userId: userId,
  allowOverbudget: allowOverbudget,
);
UpdateUserAllowOverbudgetData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.updateUserAllowOverbudget(
  userId: userId,
  allowOverbudget: allowOverbudget,
).ref();
ref.execute();
...
String userId = ...;
String scholarshipId = ...;
ExampleConnector.instance.createScholarshipApplication(
  id: id,
  userId: userId,
  scholarshipId: scholarshipId,
).execute();
...
#### Optional Arguments
We return a builder for each query. For CreateScholarshipApplication, we created `CreateScholarshipApplicationBuilder`. For queries and mutations with optional parameters, we return a builder class.
The builder pattern allows Data Connect to distinguish between fields that haven't been set and fields that have been set to null. A field can be set by calling its respective setter method like below:
```dart
class CreateScholarshipApplicationVariablesBuilder {
  ...
   CreateScholarshipApplicationVariablesBuilder message(String? t) {
   _message.value = t;
   return this;
  }
...
#### Return Type
`execute()` returns a `OperationResult<CreateScholarshipApplicationData, CreateScholarshipApplicationVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.createScholarshipApplication(
  id: id,
  userId: userId,
  scholarshipId: scholarshipId,
);
CreateScholarshipApplicationData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.createScholarshipApplication(
  id: id,
  userId: userId,
  scholarshipId: scholarshipId,
).ref();
...
String filename = ...;
String path = ...;
ExampleConnector.instance.createScholarshipAttachment(
  id: id,
...
#### Return Type
`execute()` returns a `OperationResult<CreateScholarshipAttachmentData, CreateScholarshipAttachmentVariables>`
```dart
/// Result of an Operation Request (query/mutation).
class OperationResult<Data, Variables> {
  OperationResult(this.dataConnect, this.data, this.ref);
...
final result = await ExampleConnector.instance.createScholarshipAttachment(
  id: id,
  scholarshipApplicationId: scholarshipApplicationId,
  filename: filename,
  path: path,
);
CreateScholarshipAttachmentData data = result.data;
final ref = result.ref;
```
...
final ref = ExampleConnector.instance.createScholarshipAttachment(
  id: id,
  scholarshipApplicationId: scholarshipApplicationId,
  filename: filename,
  path: path,
