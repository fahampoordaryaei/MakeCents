...
class SeedProductsOnlyVariablesBuilder {
  ...
  Deserializer<SeedProductsOnlyData> dataDeserializer = (dynamic json)  => SeedProductsOnlyData.fromJson(jsonDecode(json));
  ...
  MutationRef<SeedProductsOnlyData, void> ref() {
    ...
    return _dataConnect.mutation("SeedProductsOnly", dataDeserializer, emptySerializer, null);
  }
}
...
class SeedProductsOnlyProductInsertMany {
  ...
  bool operator ==(Object other) {
    ...
    final SeedProductsOnlyProductInsertMany otherTyped = other as SeedProductsOnlyProductInsertMany;
  ...
  SeedProductsOnlyProductInsertMany({
    required this.id,
  });
}
