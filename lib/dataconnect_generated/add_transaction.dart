...
class AddTransactionVariablesBuilder {
  ...
  AddTransactionVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<AddTransactionData> dataDeserializer = (dynamic json) =>
      AddTransactionData.fromJson(jsonDecode(json));
  Serializer<AddTransactionVariables> varsSerializer =
      (AddTransactionVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<AddTransactionData, AddTransactionVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<AddTransactionData, AddTransactionVariables> ref() {
    AddTransactionVariables vars = AddTransactionVariables(
      userId: userId,
...
class AddTransactionTransactionInsert {
  ...
  bool operator ==(Object other) {
    ...
    final AddTransactionTransactionInsert otherTyped =
        other as AddTransactionTransactionInsert;
  ...
  AddTransactionTransactionInsert({required this.id});
}
...
class AddTransactionData {
  ...
  AddTransactionData.fromJson(dynamic json)
    : transaction_insert = AddTransactionTransactionInsert.fromJson(
  ...
  AddTransactionData({required this.transaction_insert});
}
