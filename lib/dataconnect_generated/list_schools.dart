...
class ListSchoolsVariablesBuilder {
  ...
  Deserializer<ListSchoolsData> dataDeserializer = (dynamic json)  => ListSchoolsData.fromJson(jsonDecode(json));
  ...
  QueryRef<ListSchoolsData, void> ref() {
    ...
    return _dataConnect.query("ListSchools", dataDeserializer, emptySerializer, null);
  }
}
