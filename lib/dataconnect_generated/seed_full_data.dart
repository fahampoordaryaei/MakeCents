...
class SeedFullDataVariablesBuilder {
  ...
  Deserializer<SeedFullDataData> dataDeserializer = (dynamic json)  => SeedFullDataData.fromJson(jsonDecode(json));
  ...
  MutationRef<SeedFullDataData, void> ref() {
    ...
    return _dataConnect.mutation("SeedFullData", dataDeserializer, emptySerializer, null);
  }
}
...
class SeedFullDataExpenseCategoryInsertMany {
  ...
  bool operator ==(Object other) {
    ...
    final SeedFullDataExpenseCategoryInsertMany otherTyped = other as SeedFullDataExpenseCategoryInsertMany;
  ...
  SeedFullDataExpenseCategoryInsertMany({
    required this.id,
  });
}
...
class SeedFullDataScholarshipInsertMany {
  ...
  bool operator ==(Object other) {
    ...
    final SeedFullDataScholarshipInsertMany otherTyped = other as SeedFullDataScholarshipInsertMany;
    return id == otherTyped.id;
  ...
  SeedFullDataScholarshipInsertMany({
    required this.id,
  });
}
...
class SeedFullDataProductInsertMany {
  ...
  bool operator ==(Object other) {
    ...
    final SeedFullDataProductInsertMany otherTyped = other as SeedFullDataProductInsertMany;
    return id == otherTyped.id;
...
class SeedFullDataData {
  ...
  bool operator ==(Object other) {
    ...
    return expenseCategory_insertMany == otherTyped.expenseCategory_insertMany && 
    scholarship_insertMany == otherTyped.scholarship_insertMany && 
    product_insertMany == otherTyped.product_insertMany;
    
  }
  @override
  int get hashCode => Object.hashAll([expenseCategory_insertMany.hashCode, scholarship_insertMany.hashCode, product_insertMany.hashCode]);
