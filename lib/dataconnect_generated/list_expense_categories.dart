...
class ListExpenseCategoriesVariablesBuilder {
  ...
  Deserializer<ListExpenseCategoriesData> dataDeserializer = (dynamic json) =>
      ListExpenseCategoriesData.fromJson(jsonDecode(json));
...
class ListExpenseCategoriesExpenseCategories {
  ...
  bool operator ==(Object other) {
    ...
    final ListExpenseCategoriesExpenseCategories otherTyped =
        other as ListExpenseCategoriesExpenseCategories;
...
class ListExpenseCategoriesData {
  ...
  bool operator ==(Object other) {
    ...
    final ListExpenseCategoriesData otherTyped =
        other as ListExpenseCategoriesData;
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
    json['expenseCategories'] = expenseCategories
        .map((e) => e.toJson())
        .toList();
    return json;
  }

  ListExpenseCategoriesData({required this.expenseCategories});
}
